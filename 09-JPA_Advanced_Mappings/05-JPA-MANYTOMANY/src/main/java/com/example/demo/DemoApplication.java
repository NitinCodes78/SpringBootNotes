...
//            deleteCourseById(appDAO);
    ...
    private void addMoreCoursesForStudents(AppDAO appDAO) {
        ...
        Course tempCourse1 = new Course("A guide to understanding cats");
        Course tempCourse2 = new Course("My story");
    ...
    private void createCourseAndStudents(AppDAO appDAO) {
        Course tempCourse = new Course("Mario- a evergreen game");
        Student tempStudent1 = new Student("John", "Doe", "john@gmail.com");
        Student tempStudent2 = new Student("Virat", "Kohli", "virat@gmail.com");
        Student tempStudent3 = new Student("MS", "Dhoni", "dhoni@gmail.com");
